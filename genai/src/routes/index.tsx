...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Doctor Debug — Plain-English fixes for broken AI agents" },
      {
        name: "description",
        content:
          "Doctor Debug watches your no-code AI agents, catches failures, and tells you exactly what went wrong — no logs, no guesswork, no developer translation needed.",
      },
      { property: "og:title", content: "Doctor Debug — Plain-English fixes for broken AI agents" },
      {
        property: "og:description",
        content:
          "When your AI agent breaks, get a plain-English fix. Built for marketers, operators, consultants, and teams running AI agents without engineers.",
      },
